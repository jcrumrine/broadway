...
Objects as listed in the Codecademy Course: 

LEARN THE COMMAND LINE
Broadway
In this project, you'll create a website, Broadway, an image of which is provided in the steps below. You are to use your 
knowledge of HTML & CSS to recreate the web page, with several important considerations:

1. The website will look like this. You can also find a detailed description of the styles in these redline mocks.

2. You are to use Git and GitHub for version control, to initialize the Git repository, commit each change, and 
